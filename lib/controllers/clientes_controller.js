...
const createClienteConsulta = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const clienteResult = yield db_connect_1.default.query('INSERT INTO clientes (nombre, apellido, email, telefono, empresa, cargo) VALUES ($1, $2, $3, $4, $5, $6) RETURNING id_cliente', [nombre, apellido, email, telefono, empresa, cargo]);
        const id_cliente = clienteResult.rows[0].id_cliente;
        // Inserta la consulta en la tabla 'consultas' vinculada con 'cliente_id'
        yield db_connect_1.default.query('INSERT INTO consultas (servicio, consulta, cliente_id) VALUES ($1, $2, $3)', [servicio, consulta, id_cliente]);
        return res.status(201).json({
